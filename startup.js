...
async function main() {
  ...
  try {
    ...
    const typesCmr = [
      ...
      { slug: 'liquidation-retraite',           libelle: "Demande de liquidation de pension de retraite",    delaiMaxJours: 45,   actif: true  },
      ...
      { slug: 'adhesion-assurance-maladie-faam',libelle: "Adhésion à l'Assurance Maladie - FAAM",            delaiMaxJours: 60,   actif: true  },
