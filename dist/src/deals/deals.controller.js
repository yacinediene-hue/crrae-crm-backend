...
let DealsController = class DealsController {
    ...
    async remove(id, req) {
        ...
        this.audit.log({ auteur: req.user.email, auteurId: req.user.id, action: 'DELETE_DEAL', entite: 'Deal', entiteId: id });
        return result;
    }
};
...
exports.DealsController = DealsController = __decorate([
    ...
    __metadata("design:paramtypes", [deals_service_1.DealsService, audit_service_1.AuditService])
], DealsController);
